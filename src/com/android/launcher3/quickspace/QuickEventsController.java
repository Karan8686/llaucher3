...
public class QuickEventsController {
    ...
    private void psonalityEvent() {
        ...
        if (luckNumber < 7) {
            ...
            mEventSubIcon = ContextCompat.getDrawable(mContext, R.drawable.ic_quickspace_infinity);
            mIsQuickEvent = true;
            return;
        }
    ...
    public void onPause() {
        ...
        // Clear drawable references to free memory
        if (mEventSubIcon != null) {
            mEventSubIcon.setCallback(null);
            mEventSubIcon = null;
        }
    }
    ...
    public void cleanup() {
        unregisterPSAListener();
        // Clear all cached string arrays
        mCachedPSAMap.clear();
        // Clear drawable reference
        if (mEventSubIcon != null) {
            mEventSubIcon.setCallback(null);
            mEventSubIcon = null;
        }
        // Clear all string references
        mEventTitle = null;
        mEventTitleSub = null;
        mGreetings = null;
        mClockExt = null;
